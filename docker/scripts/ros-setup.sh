...
basic_ignore_pkgs="${grid_map_pkgs} ${realsense_pkgs} ros1_bridge groot oakd rplidar_ros metalbot_gazebo"

echo "alias r1='source /opt/ros/noetic/setup.zsh && source ~/ros1_ws/devel/setup.zsh'" >> ~/.zshrc
echo "alias r2='source /opt/ros/foxy/setup.zsh && source ~/ros2_ws/install/setup.zsh && source ~/micro_ros_ws/install/local_setup.zsh'" >> ~/.zshrc
...
echo "alias cb_gazebo='colcon build --symlink-install --packages-select metalbot_gazebo'" >> ~/.zshrc
