...
def generate_launch_description():
    ...
    camera_link_tf = launch_ros.actions.Node(
        ...
        executable='static_transform_publisher',
        output='log',
        arguments=['-0.03', '0', '0.11', '0', '0', '0', 'base_link_filtered', 'camera_link'],
        parameters=[
    		rosbot_description + '/config/static_tf.yaml'
        ]
    )
    ...
    laser_frame_tf = launch_ros.actions.Node(
        ...
        executable='static_transform_publisher',
        output='log',
        arguments=['0.0', '0.0', '0.08', '-3.141593', '0.0', '0.0', 'base_link_filtered', 'laser'],
        parameters=[
    		rosbot_description + '/config/static_tf.yaml'
        ]
    )
    ...
    return LaunchDescription([
        ...
        launch_ros.actions.Node(
            ...
            executable='static_transform_publisher',
            output='screen',
            arguments=['0.08', '0.1', '0', '0', '0', '0', 'base_link_filtered', 'front_left_wheel'],
            ),        
        launch_ros.actions.Node(
            package='tf2_ros',
            executable='static_transform_publisher',
            output='screen',
            arguments=['0.08', '-0.1', '0', '0', '0', '0', 'base_link_filtered', 'front_right_wheel'],
            ),
        launch_ros.actions.Node(
            package='tf2_ros',
            executable='static_transform_publisher',
            output='screen',
            arguments=['-0.08', '0.1', '0', '0', '0', '0', 'base_link_filtered', 'rear_left_wheel'],
            ),        
        launch_ros.actions.Node(
            package='tf2_ros',
            executable='static_transform_publisher',
            output='screen',
            arguments=['-0.08', '-0.1', '0', '0', '0', '0', 'base_link_filtered', 'rear_right_wheel'],
            ),
        launch_ros.actions.Node(
            package='tf2_ros',
            executable='static_transform_publisher',
            output='screen',
            arguments=['0', '0', '0', '0', '0', '0', 'base_link_filtered', 'top'],
        ),
        launch_ros.actions.Node(
            package='tf2_ros',
            executable='static_transform_publisher',
            output='screen',
            arguments=['0', '0', '0.18', '0', '0', '0', 'base_link_filtered', 'camera_link'],
        ),
