...
class ElevationMap {
 public:
  ...
  /*!
  * Gets number of postprocessor threads from node parameters.
  * @param nodeHandle the node instance.
  * @return number of posprocessor threads from node parameters.
  */
  std::size_t getPostprocessorThreads(rclcpp::Node::SharedPtr nodeHandle);
  ...
  */
   ...
   */
  void underlyingMapCallback(const grid_map_msgs::msg::GridMap::ConstPtr& underlyingMap);
