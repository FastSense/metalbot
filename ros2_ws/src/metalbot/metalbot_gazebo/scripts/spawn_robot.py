...
class RobotSpawner(Node):
    """
    Simple node for robot spawn
    The node parses the robot model, changes the frequency of 
    ...
    def init_parameters(self):
        ...
        """
        self.declare_parameter('odom_update_rate', "10")
    ...
    def get_node_parametes(self):
        ...
        self.update_rate = self.get_parameter(
            'odom_update_rate').get_parameter_value().integer_value
