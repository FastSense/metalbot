...
def generate_launch_description():
    ...
    spawn_launch     = PathJoinSubstitution([robot_gazebo_pkg,   'launch',  'spawn_no_static_tf.launch.py'])
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('odom_update_rate', default_value='10', description='odom update rate'),
